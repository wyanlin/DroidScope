...
public final class WindowInfo {
    ...
    public WindowInfo(int order, String title, String packageName, int userId, String componentName,
        ...
        this(order, title, packageName, userId, componentName, displayId, pid, uid, -1,
                focused, visible, hasSurface, rawBlock, relatedActivityId);
    }

    public WindowInfo(int order, String title, String packageName, int userId, String componentName,
                      int displayId, int pid, int uid, int windowType, boolean focused, boolean visible,
                      boolean hasSurface, String rawBlock, String relatedActivityId) {
        this.order = order;
        this.title = title;
    ...
    public int windowType() { return windowType; }
    ...
    public WindowInfo withRelatedActivityId(String activityId) {
        return new WindowInfo(order, title, packageName, userId, componentName, displayId, pid, uid,
                windowType, focused, visible, hasSurface, rawBlock, activityId);
    }
}
